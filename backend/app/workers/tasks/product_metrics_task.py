...
def compute_metrics(conn, shop_domain: str, product_url: str, now_ms: int) -> dict:
    ...
    See aggregation_worker.py original docstring for the full metric
    definitions and attribution rules. This function is pure — it owns
    no mutable state, only reads events + shop_orders and returns a dict.
    """
    ...
    purchase_result = compute_purchase_metrics(
