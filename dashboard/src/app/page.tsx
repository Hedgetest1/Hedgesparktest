...
function Pricing() {
  ...
  const compare: Array<{ group: string; rows: Array<{ name: string; lite: boolean; pro: boolean; scale: boolean }> }> = [
    {
      ...
      rows: [
        { name: "First-party pixel tracker", lite: true, pro: true, scale: true },
        { name: "Revenue at Risk Score — the entry hook (Lite: headline · Pro: 5-dim breakdown)", lite: true, pro: true, scale: true },
        { name: "Today + last 7 days KPI snapshot", lite: true, pro: true, scale: true },
        { name: "Daily intelligence brief", lite: true, pro: true, scale: true },
        { name: "Multi-currency rollup (no fake-sum)", lite: true, pro: true, scale: true },
      ],
    },
    {
      group: "Lite — full $0-60 parity",
      rows: [
        { name: "P&L · attribution · cohort retention · refunds", lite: true, pro: true, scale: true },
        { name: "Multi-store consolidation (per-currency)", lite: true, pro: true, scale: true },
        { name: "11-segment RFM + geographic drilldown", lite: true, pro: true, scale: true },
        { name: "Custom report builder + scheduled email", lite: true, pro: true, scale: true },
        { name: "Google Sheets / CSV / PDF export", lite: true, pro: true, scale: true },
        { name: "Post-purchase survey (multi-question)", lite: true, pro: true, scale: true },
        { name: "AI assistant (SparkChat) on your data", lite: true, pro: true, scale: true },
        { name: "Peer benchmarks (anonymous)", lite: true, pro: true, scale: true },
    ...
    },
    {
      ...
      rows: [
        ...
        { name: "Subscription analytics (recurring orders, MRR, churn)", lite: false, pro: true, scale: true },
      ],
    },
    {
      group: "Scale — moat intelligence (no competitor < $1k ships these)",
      rows: [
        { name: "Causal Lift + Why engine (real A/B holdout)", lite: false, pro: false, scale: true },
        { name: "Night Shift Agent + Timeline (overnight inference loop)", lite: false, pro: false, scale: true },
        { name: "Competitor Playbook (anonymized peer network)", lite: false, pro: false, scale: true },
        { name: "Anomaly Fusion + Replay (event-level reconstruction)", lite: false, pro: false, scale: true },
        { name: "Counterfactual Explorer (cost-of-delay projections)", lite: false, pro: false, scale: true },
        { name: "Revenue Autopsy + Revenue Genome", lite: false, pro: false, scale: true },
        { name: "Nudge DNA + holdout-measured Lift Report", lite: false, pro: false, scale: true },
        { name: "MTA model compare", lite: false, pro: false, scale: true },
  ...
  const tiers = [
    ...
    },
    {
      key: "scale",
      label: "Scale",
      tagline: "Northbeam-class moats",
      desc: "Everything in Pro, plus the deep-intelligence moats that no competitor ships under $1k/mo: Causal Lift, MTA Compare, Anomaly Fusion, Revenue Autopsy, Night Shift Agent, holdout-measured Lift Report.",
      features: [
        "Everything in Pro",
        "Causal Lift + Why engine (real A/B holdout)",
        "Night Shift Agent + Timeline",
        "Anomaly Fusion + Replay",
        "Counterfactual Explorer",
        "Competitor Playbook (peer network)",
        "Revenue Autopsy + Genome + Nudge DNA",
        "MTA model compare + Lift Report",
        "Agency white-label + API + webhooks",
      ],
      accent: "#3b82f6",
      recommended: false,
    },
