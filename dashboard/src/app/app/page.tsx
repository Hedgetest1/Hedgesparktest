...
function PageInner() {
  ...
  // Cost defaults, Privacy (Art.22) and Klaviyo state were retired
  // from this file 2026-04-21 Phase 2. Each lives now in its own
  // sub-page under /app/settings/{cost-defaults,privacy,klaviyo} with
  // its own hook (useCostDefaults / usePrivacyOptOut /
  // useKlaviyoConnection in lib/hooks/). Nothing outside those pages
  // reads the old state, so this section is now just a comment
  // breadcrumb for archaeology.
        ...
        <main ref={mainRef} className="flex-1 overflow-y-auto hs-scroll-smooth">
          {!sessionResolved ? (
            ...
            <div className="space-y-6 px-6 py-6 pb-[70vh]">
              ...
              {/* Settings section migrated fully 2026-04-21 to
