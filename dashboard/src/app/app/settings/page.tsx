...
const SETTINGS: SettingsCard[] = [
  ...
  {
    href: "/app/settings/google-sheets",
    title: "Google Sheets export",
    blurb:
      "Export any HedgeSpark report to a new Google Sheet in one click. Drive.file scope — we only access sheets HedgeSpark creates, never your existing files.",
    status: "live",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    href: "/app/settings/surveys",
    title: "Post-purchase survey",
    blurb:
      "One warm question on your Thank-You page — \"how did you hear about us?\". Edit the question, swap the answer choices, toggle free-text — all tiers.",
    status: "live",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
