 ...
 * Phase 1.8.3 will migrate the actual Pro components (RevenueAutopsy,
 * CausalLift, Cohort, P&L, etc.) from /app/page.tsx to here.
 *
 * Today this page renders a preview list of what Pro unlocks. Lite
 * merchants see every Pro capability listed with a lock badge +
 * upgrade CTA. Pro merchants see the same list with a note that the
 * live interactive versions arrive in 1.8.3.
 */
          ...
          {isProUser && (
            <div className="mt-10 rounded-2xl border border-violet-400/20 bg-violet-500/[0.04] p-5">
              <p className="text-[13px] leading-relaxed text-slate-300">
                ...
                these cards migrate here in the next deploy — Phase
                1.8.3. For now, use the Pulse floor (home) for your
                daily dashboard.
              </p>
            </div>
          )}
