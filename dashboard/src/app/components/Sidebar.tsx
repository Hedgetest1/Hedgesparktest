...
const SECTION_TO_NAV_LITE: Record<string, string> = {
  ...
  "lite-goals": "lite-goals",
  "lite-bisql": "lite-bisql",
  // Inner anchors of nested ProParityGapPlaceholder + SessionsSection
  // — roll them up to the outer Lite nav slot so scroll-spy stays
  // lit while reading these sub-blocks.
  "lite-goals-inner": "lite-goals",
  "lite-bisql-inner": "lite-bisql",
